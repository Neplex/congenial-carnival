...
/*!
 * \file
 * This module provides the classes to represent the different parts of
...
public:
   ...
   */
  Expr(priority_enum p) : priority(p){};
  /*!
   ...
   */
  priority_enum get_priority() const { return priority; };
  /*! Destructor. */
  virtual ~Expr(){};
};
...
public:
   ...
   */
  Constant(double v) : Expr(priority_var_con), value(v){};
  /*! Destructor. */
  ~Constant(){};
