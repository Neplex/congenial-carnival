...
/*!
 * \file
 * This file provides the classes to manage the context of evaluation, in
 * particular the value of variables.
 *
 * \author PASD
 * \date 2016
 */
...
public:
   ...
   */
  virtual void valuate(std::string const &id, double value) = 0;
 ...
 */
class Evaluation_Context_No_Variable : public Evaluation_Context {
public:
  /*! It is asserted that this method is not used. */
  double get_value(std::string const &id);
  /*! It is asserted that this method is not used. */
  void valuate(std::string const &id, double value);
};
 ...
 */
class Evaluation_Context_Simple : public Evaluation_Context {
protected:
